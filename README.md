...
| `port_scanner.py` | Review open TCP services across authorized hosts, host lists, or small CIDR ranges. | Supports authorized service exposure review with CSV, JSON, and Markdown reporting. | Ready |
...
| Authorized service exposure review | `python port_scanner.py --target-file samples/authorized_scope_sample.txt --ports 22,80,443,445,3389 --format md --output exposure.md` |
...
python port_scanner.py --targets 127.0.0.1,localhost --ports 22,80,443 --format md --output service_exposure.md
